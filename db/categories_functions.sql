...
BEGIN
	...
	ELSIF tags->'shop' = 'art' AND area SIMILAR TO '(DE|AT|CH|FR)%' THEN
		RETURN 'art';
	ELSIF tags->'shop' = 'bookmaker' AND area SIMILAR TO '(DE|AT|CH)%' THEN
		RETURN 'bookmaker';
	...
	ELSIF tags->'shop' = 'frame' AND area SIMILAR TO '(DE|AT|CH)%' THEN
		RETURN 'frame';
	ELSIF tags->'shop' = 'gift' AND area SIMILAR TO '(DE|AT|CH|FR)%' THEN
		RETURN 'gift';
	ELSIF tags->'shop' = 'locksmith' AND area SIMILAR TO '(DE|AT|CH)%' THEN
		RETURN 'locksmith';
	ELSIF tags->'shop' = 'lottery' AND area SIMILAR TO '(DE|AT|CH)%' THEN
		RETURN 'lottery';
	ELSIF tags->'shop' = 'mall' AND area SIMILAR TO '(DE|AT|CH)%' THEN
		RETURN 'mall';
	...
	ELSIF tags->'shop' = 'photo' AND area SIMILAR TO '(DE|AT|CH|FR)%' THEN
		RETURN 'photo';
