...
BEGIN
	...
	ELSIF (tags->'amenity' = 'bank' AND area LIKE 'CD%') OR (tags->'amenity' = 'atm' AND area LIKE 'CD%') OR (tags->'amenity' = 'money_transfer' AND area LIKE 'CD%') OR (tags->'amenity' = 'mobile_money_agent' AND area LIKE 'CD%') THEN
		RETURN 'money';
	ELSIF (tags->'shop' = 'bag' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'beauty' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'cosmetics' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'hairdresser' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'jewelry' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'massage' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'perfumery' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' IN ('shoes', 'boutique', 'clothes', 'fashion', 'tailor', 'chemist')) OR (tags->'craft' = 'shoemaker') THEN
		RETURN 'clothing_beauty';
	ELSIF (tags->'shop' = 'bed' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' IN ('bathroom_furnishing', 'carpet', 'curtain', 'furniture', 'kitchen') AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'household_linen' AND area LIKE 'FR%') OR (tags->'shop' = 'houseware' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'interior_decoration' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'pottery' AND area SIMILAR TO '(DE|AT|CH|IT)%') OR (tags->'shop' = 'watches' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'lighting' AND area SIMILAR TO '(AT|CH|DE|IT|FR)%') OR (tags->'shop' = 'hifi' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' IN ('doityourself', 'electrical', 'fireplace', 'glaziery', 'hardware', 'paint', 'tiles', 'electronics', 'appliance')) OR (tags->'craft' = 'electronics_repair') THEN
		RETURN 'home_equipment';
	ELSIF (tags->'shop' = 'printer_ink' AND area LIKE 'IT%') OR (tags->'shop' = 'stationery' AND area SIMILAR TO '(AT|CH|DE|FR|IT)%') OR (tags->'shop' = 'agrarian' AND area SIMILAR TO '(AT|CH|DE|FR|IT)%') OR (tags->'shop' = 'books' AND area SIMILAR TO '(DE|AT|CH|IT|FR)%') OR (tags->'amenity' = 'vending_machine' AND tags->'vending' = 'books' AND area SIMILAR TO '(DE|AT|CH|IT|FR)%') OR (tags->'shop' = 'art' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'charity' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'department_store' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'gift' AND tags->'opening_hours:covid19' != '' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'music' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'musical_instrument' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'photo' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'second_hand' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'ticket' AND area SIMILAR TO '(DE|AT|CH|IT)%') OR (tags->'shop' = 'toys' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'trade' AND area SIMILAR TO '(DE|AT|CH|IT)%') OR (tags->'shop' = 'travel_agency' AND area SIMILAR TO '(DE|AT|CH|IT)%') OR (tags->'shop' = 'variety_store' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'video' AND area SIMILAR TO '(DE|AT|CH|IT)%') OR (tags->'shop' = 'video_games' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'shop' = 'weapons' AND area SIMILAR TO '(DE|AT|CH)%') OR (tags->'shop' = 'wholesale' AND area SIMILAR TO '(DE|AT|CH|IT)%') OR (tags->'shop' IN ('fishing', 'hunting', 'sports', 'outdoor') AND area SIMILAR TO '(DE|AT|CH|FI|FR|IT)%') OR (tags->'amenity' = 'vending_machine' AND tags->'vending' = 'cigarettes') OR (tags->'amenity' = 'vending_machine' AND tags->'vending' = 'e-cigarettes') OR (tags->'shop' IN ('mobile_phone', 'computer', 'dry_cleaning', 'laundry', 'kiosk', 'newsagent', 'pet', 'garden_centre', 'florist', 'fabric', 'sewing', 'haberdashery', 'wool', 'tobacco', 'newsagent;tobacco', 'tobacco;newsagent', 'e-cigarette')) OR (tags->'newsagent' = 'yes') OR (tags->'craft' = 'sewing') OR (tags->'tobacco' IN ('yes', 'only')) THEN
		RETURN 'shop';
	ELSIF (tags->'shop' = 'car' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'amenity' = 'car_wash' AND area SIMILAR TO '(AT|CH|DE|IT|FR)%') OR (tags->'shop' = 'motorcycle' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'amenity' = 'vending_machine' AND tags->'vending' = 'bicycle_tube') OR (tags->'shop' = 'tyres' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%') OR (tags->'amenity' IN ('fuel', 'car_rental')) OR (tags->'shop' IN ('gas', 'bicycle', 'car_parts', 'car_repair')) THEN
		RETURN 'mobility';
...
BEGIN
	...
	ELSIF (tags->'amenity' IN ('bank', 'money_transfer', 'mobile_money_agent') AND area SIMILAR TO '(DE|FR|ES|AD|CH|AT|PH|FI|MC|IT|GB|IE)%') OR (tags->'shop' = 'money_lender' AND area SIMILAR TO '(DE|FR|ES|AD|CH|AT|PH|FI|MC|IT|GB|IE)%') THEN
		RETURN 'money';
	ELSIF (tags->'office' = 'insurance') OR (tags->'shop' = 'insurance') THEN
		RETURN 'insurance';
	ELSIF tags->'tourism' = 'information' AND tags->'information' = 'office' THEN
		RETURN 'tourism_info';
	ELSIF tags->'tourism' IN ('hotel', 'motel', 'hostel') AND area SIMILAR TO '(FR|AT|DE|CH|IT)%' THEN
		RETURN 'hotel';
	...
	ELSIF tags->'amenity' = 'library' AND area SIMILAR TO '(AT|CH|DE|FI|IT|FR)%' THEN
		RETURN 'library';
	ELSIF tags->'shop' = 'copyshop' AND area SIMILAR TO '(AT|CH|DE|IT|FR)%' THEN
		RETURN 'copyshop';
	ELSIF tags->'craft' = 'key_cutter' AND area LIKE 'FR%' THEN
		RETURN 'key_cutter';
	...
	ELSIF tags->'shop' IN ('bakery', 'pastry') THEN
		RETURN 'bakery';
	ELSIF (tags->'shop' IN ('alcohol', 'beverages', 'wine', 'winery') AND area SIMILAR TO '(CD|FR)%') OR (tags->'craft' = 'distillery' AND area SIMILAR TO '(CD|FR)%') THEN
		RETURN 'alcohol';
	ELSIF tags->'amenity' = 'vending_machine' AND tags->'vending' IN ('pizza', 'drinks', 'water', 'sweets', 'bread') THEN
	...
	ELSIF (tags->'shop' = 'shoes') OR (tags->'craft' = 'shoemaker') THEN
		RETURN 'shoes';
	...
	ELSIF tags->'shop' IN ('doityourself', 'electrical', 'fireplace', 'glaziery', 'hardware', 'paint', 'tiles') THEN
		RETURN 'hardware';
	ELSIF tags->'shop' = 'bed' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'bed';
	ELSIF tags->'shop' IN ('bathroom_furnishing', 'carpet', 'curtain', 'furniture', 'kitchen') AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'furniture';
	ELSIF tags->'shop' = 'household_linen' AND area LIKE 'FR%' THEN
		RETURN 'household_linen';
	ELSIF tags->'shop' = 'houseware' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'houseware';
	ELSIF tags->'shop' = 'interior_decoration' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'interior_decoration';
	ELSIF tags->'shop' = 'pottery' AND area SIMILAR TO '(DE|AT|CH|IT)%' THEN
		RETURN 'pottery';
	ELSIF tags->'shop' = 'watches' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'watches';
	ELSIF tags->'shop' = 'lighting' AND area SIMILAR TO '(AT|CH|DE|IT|FR)%' THEN
		RETURN 'lighting';
	ELSIF tags->'shop' = 'hifi' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'hifi';
	...
	ELSIF (tags->'shop' IN ('fabric', 'sewing', 'haberdashery', 'wool')) OR (tags->'craft' = 'sewing') THEN
		RETURN 'sewing';
	ELSIF (tags->'shop' = 'books' AND area SIMILAR TO '(DE|AT|CH|IT|FR)%') OR (tags->'amenity' = 'vending_machine' AND tags->'vending' = 'books' AND area SIMILAR TO '(DE|AT|CH|IT|FR)%') THEN
		RETURN 'books';
	ELSIF tags->'shop' = 'art' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'art';
	ELSIF tags->'shop' = 'charity' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'charity';
	ELSIF tags->'shop' = 'department_store' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'department_store';
	ELSIF tags->'shop' = 'gift' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'gift';
	ELSIF tags->'shop' = 'music' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'music';
	ELSIF tags->'shop' = 'musical_instrument' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'musical_instrument';
	ELSIF tags->'shop' = 'photo' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'photo';
	ELSIF tags->'shop' = 'second_hand' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'second_hand';
	ELSIF tags->'shop' = 'ticket' AND area SIMILAR TO '(DE|AT|CH|IT)%' THEN
		RETURN 'ticket';
	ELSIF tags->'shop' = 'toys' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'toys';
	ELSIF tags->'shop' = 'trade' AND area SIMILAR TO '(DE|AT|CH|IT)%' THEN
		RETURN 'trade';
	ELSIF tags->'shop' = 'travel_agency' AND area SIMILAR TO '(DE|AT|CH|IT)%' THEN
		RETURN 'travel_agency';
	ELSIF tags->'shop' = 'variety_store' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'variety_store';
	ELSIF tags->'shop' = 'video' AND area SIMILAR TO '(DE|AT|CH|IT)%' THEN
		RETURN 'video';
	ELSIF tags->'shop' = 'video_games' AND area SIMILAR TO '(DE|AT|CH|FR|IT)%' THEN
		RETURN 'video_games';
	ELSIF tags->'shop' = 'weapons' AND area SIMILAR TO '(DE|AT|CH)%' THEN
		RETURN 'weapons';
	ELSIF tags->'shop' = 'wholesale' AND area SIMILAR TO '(DE|AT|CH|IT)%' THEN
		RETURN 'wholesale';
	ELSIF tags->'shop' IN ('fishing', 'hunting', 'sports', 'outdoor') AND area SIMILAR TO '(DE|AT|CH|FI|FR|IT)%' THEN
		RETURN 'sports';
