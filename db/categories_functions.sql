...
BEGIN
	...
	ELSIF tags->'shop' = 'beauty' AND area SIMILAR TO '(DE|AT|CH)%' THEN
		RETURN 'beauty';
	ELSIF tags->'shop' IN ('boutique', 'clothes', 'fashion', 'tailor') AND area SIMILAR TO '(DE|AT|CH)%' THEN
		RETURN 'clothes';
